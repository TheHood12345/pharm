...
function P_landing_1({day,set_num}){
    ...
    useEffect(()=>{
        setTimeout(()=>{
                ...
                //set_promo_images(prev=> [...prev, lis[1]]);
                // set_promo_images(prev=>{
                //     const copy = [...prev];
    ...
    return (
        <div style={{width:"100%",height:"85%",overflow:"scroll",display:"flex",flexDirection:"column",alignItems:"center",backgroundColor:day==true?"white":"rgb(18,22,28)",color:day==true?"rgb(18,22,28)":"white",position:"relative"}}>
            ...
            <div style={{width:"90%",position:"relative",marginTop:"10px",paddingTop:"1%",paddingBottom:"1%",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center",backgroundColor:"rgb(240,240,240)",borderRadius:"10px"}}>
